...
* ![MUI](https://img.shields.io/badge/MUI%20-%5E5.14.10-blue?logo=MUI&logoColor=%23007FFF)
...
![GitHub](https://img.shields.io/badge/GitHub-gray?logo=github&logoColor=white)からクローンしてもらい![yarn](https://img.shields.io/badge/yarn-gray?logo=yarn&logoColor=%232C8EBB)で必要なパッケージをダウンロードしてください。
```
...
`yarn build`
でdistフォルダーに作成されます。
* ![Jest](https://img.shields.io/badge/Jest-gray?logo=jest&logoColor=%23C21325)でのテスティングは
`yarn test`
で行なうことができます。
